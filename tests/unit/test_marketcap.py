...
def test_build_mcap_history_returns_forward_filled_frame() -> None:
    ...
    assert history.loc[pd.Timestamp("2021-03-31"), "000002.KS"] == 120
...
def test_get_top_mcap_at_is_point_in_time() -> None:
    ...
    assert get_top_mcap_at(history, "2021-01-15", n=2) == ["000001.KS", "000002.KS"]
    assert get_top_mcap_at(history, "2021-04-15", n=2) == ["000002.KS", "000001.KS"]
